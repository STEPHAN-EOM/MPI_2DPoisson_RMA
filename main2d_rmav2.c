...
// Question.2 => Define the windows for RMA
MPI_Win wina, winb;

// Qiestion.2 => Create the windows for RMA
...
// Question.3 => Create two groups for PSCW
...
// Question2. => Implementation of the 2D ghost exchange routin: PSCW
exchang_2d_RMA_pscw(a, ny, s, e, MPI_COMM_WORLD, nbrleft, nbrright, nbrdown, nbrup, wina, source, dest);
sweep_2d(a, f, nx, s, e, b);
exchang_2d_RMA_pscw(b, nx, s, e, MPI_COMM_WORLD, nbrleft, nbrright, nbrdown, nbrup, winb, source, dest);
